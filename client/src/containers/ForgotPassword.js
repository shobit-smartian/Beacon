                        ...
                        <div className="login-wrapper reset-module">
                            ...
                            <div className="col-sm-12 center-form">
                                ...
                                <div className="error-msg ">
                                    ...
                                    <span> 
                                        An account doesn't exist with that email.Try again or  Sign up below.
                                    </span> 
                                ...
                                <p className="mt-3"> Enter your email below and we'll send you an emailwith instructions to reset your password.</p>
                                    ...
                                    <div className="col-sm-12 form-group">
                                        ...
                                        <button type="submit" className="btn primary-btn">Reset my password</button>
