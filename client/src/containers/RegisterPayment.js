...
class RegisterPayment extends Component {
    ...
    componentDidMount() {
        ...
        this.setState({...this.state, ...{userInfo: this.props.location.state}})
    }
                            ...
                            <div className="col-sm-12 center-form register-payment">
                                ...
                                <form className="mt-5 mb-4">
                                    ...
                                    <div className="col-sm-12 form-group mt-3">
                                        ...
                                        <input value={userInfo.name} ref="name" type="text" placeholder="Full name"
                                    ...
                                    <div className="col-sm-12 form-group">
                                        ...
                                        <div className="input-group d-flex credit-details">
                                            ...
                                            <InputMask maskChar=' ' id='card_num' ref='card_number'
                                                       placeholder="Credit card number" className="form-control"
                                                       mask="9999-9999-9999-9999"/>

                                            <InputMask maskChar=' ' id='card_exp' ref='card_expiry' placeholder="MM/YYYY"
                                                       className="form-control card-month" mask="99/9999"/>

                                            <InputMask maskChar=' ' id='cvv' ref='cvv' placeholder="CVV"
                                                       className="form-control card-cvv" mask="999"/>
                                    ...
                                    <div className="col-sm-12 form-group text-right">
                                        ...
                                        <a onClick={() => this.setState({...this.state, ...{coupon: !this.state.coupon}})}
                                           className="form-link-text">Enter a discount coupon</a>
...

                                    {
                                        ...
                                        <div className="col-sm-12 d-flex">
                                            ...
                                            <button type="button" className="btn discount_btn"> Apply</button>
                                    ...
                                    <div className="col-sm-12 form-group">
                                        ...
                                        <button type="button" onClick={this.makePayment}
                                                className="btn primary-btn"> Pay $ 13 USD
                                        </button>
    ...
    validateInput = () => {
        ...
        return !(
            this.state.userInfo.card_number.length < 16 || this.state.userInfo.card_number.length < 3 || parseInt(this.state.userInfo.card_exp[0], 0) > 12 ||
