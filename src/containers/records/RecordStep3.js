                    ...
                    <div className="card text-center single">
                        ...
                        <div className="card-block">
                            ...
                            <div className="form-check text-left">
                                ...
                                <Checkbox onChange={this.changePermission('checkTwo')} id='check2'
                                          checked={this.state.permissions.checkTwo} color="primary"/>

                                <label className="form-check-label" for="check2"> Do not show this message
                                    again </label>
